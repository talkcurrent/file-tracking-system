                        ...
                        departments.map((department, index) => {
                            return (
                                <HorizontalUserCard
                                    ...
                                    cardLink={ `/super/department/${department.id}` }
                                    fSize={ "" }
                                    lHeight={ 1 }
                                    margin={ "0 10px" }
                                    bShadow={ "0px 0px 3px #296DBB" }
                                >
                                    <Link to={ `/super/department/${department.id}` }>
                                    ...
                                    >
                                        ...
                                        <TooltipBtn
                                            toolTip={ true }
                                            closeable={ true }
                                            closeTooltip={ state.closeTooltip && state.assignmentDept == department.id }
                                            fontSize={ "small" }
                                            context={ context }
                                            btnText={ "Delete" }
                                            tooltipBgc={ "white" }
                                        ...
                                        >
                                            <TooltipContents
                                                ...
                                                justifyItems={ "center" }
                                            >
                                                { !department.staffs_count ?
                                                    <>
                                                        <div>This action cannot be reversed. Delete anyway?</div>
                                                        <ActionBtn
                                                            btnClick={ () => deleteDept(department.id) }
                                                            btnText={ "Delete department" }
                                                            processing={ state.deletingDept && department.id == state.assignmentDept }
                                                            progressText={ "Deleting" }
                                                            disabled={ state.deletingDept && department.id == state.assignmentDept }
                                                            fontSize={ "small" }
                                                            fWeight={ 200 }
                                                            color={ "rgb(255 95 69)" }
                                                            bgc={ "white" }
                                                    ...
                                                    :
                                                    <div>This department cannot be deleted. Please romove its staff first.</div>
                                                }
                                            </TooltipContents>
                                        </TooltipBtn>
                                        ...
                                        <TooltipBtn
                                            ...
                                            textColor={ "gray" }
                                            backgroundColor={ "white" }
                                            tooltipMounted={ () => handleEditForm(department) }
                                        >
                                            <Form
                                                gap={ "10px" }
                                                width={ "250px" }
                                                processing={ state.editingDept && state.assignmentDept == department.id }
                                                progressText={ "Updating" }
                                                btnSubmitText={ "Update department" }
                                                handleSubmit={ () => updateDept(department.id) }
                                                disabled={ state.editingDept && state.assignmentDept == department.id }
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <FormSelInput
                                                            type={ "year" }
                                                            value={ form2.faculty_id }
                                                            handleChange={ handleEditChange }
                                                            label={ "Choose faculty" }
                                                            disabled={ false }
                                                            nameUniq={ "faculty_id" }
                                                            error={ editerrorField.faculty_id }
                                                            height={ "1.9rem" }
                                                            selectText={ "-- select --" }
                                                        >
                                                            { faculties.length ?
                                                ...
                                                { state.editMsg != "" && !state.editingDeptFailed ?
