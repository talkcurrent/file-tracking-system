...
import isObjectEmpty from '../customHooks/isObjectEmpty';
...
const Dashboard = (props) => {
    ...
    const {
        ...
        forwardedFiles, receivedFiles, renderSwitch,
                    ...
                    >
                        ...
                        >
                            <div className="shortcut-card">
                                <Link to={ "/super/profile" }>
                                    <div className={ "shortcut" }>
                                        <i className="fas fa-user"></i>
                                        <span>Profile</span>
                                    </div>
                                </Link>
                                <Link to={ "/super/staffs" }>
                                    <div className={ "shortcut" }>
                                ...
                                <Link to={ "/super/archives" }>
                                    <div className={ "shortcut" }>
                                        <i className="far fa-file-archive"></i>
                                        <div>Archives</div>
                                    </div>
                                </Link>
                                <Link to={ "/super/express" }>
                                    <div className={ "shortcut" }>
                                        <i className="fas fa-plane-departure"></i>
                                        <div>Express</div>
                                    </div>
                                </Link>
                                <Link to={ "/super/faculties" }>
                                    <div className={ "shortcut" }>
                                        <i className="fas fa-home"></i>
                                        <div>Faculties</div>
                                    </div>
                                </Link>
                                <Link to={ "/super/departments" }>
                                    <div className={ "shortcut" }>
