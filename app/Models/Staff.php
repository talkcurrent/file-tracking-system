...
class Staff extends Authenticatable
{
    ...
    {
        return $this->belongsToMany(Role::class, 'role_staff')->withTimestamps();
    }
    ...
    {
        return $this->morphMany(Express::class, 'receiver');
    }

    public function forwarded()
    {
        return $this->morphMany(Express::class, 'forwarder');
    }
